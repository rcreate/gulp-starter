...
gulp.task('git:add', function () {
    return gulp.src([rootPath('package.json'), rootPath('composer.json'), rootPath(GULP_CONFIG.root.dist)])
    .pipe(git.add());
});
...
gulp.task('git:commit', function () {
    ...
    return gulp.src([pkgPath, rootPath('composer.json'), rootPath(GULP_CONFIG.root.dist)])
